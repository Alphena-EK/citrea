...
enum TransactionKindLightClient {
    ...
    ChunkedPart = 2,
    /// This type of transaction includes a new batch prover method_id
    BatchProverMethodId = 3,
    Unknown(NonZeroU16),
}
...
impl TransactionKindLightClient {
    ...
    fn to_bytes(&self) -> Vec<u8> {
        match self {
            ...
            TransactionKindLightClient::BatchProverMethodId => 3u16.to_le_bytes().to_vec(),
    ...
    fn from_bytes(bytes: &[u8]) -> Option<TransactionKindLightClient> {
        ...
        match u16::from_le_bytes(kind_bytes) {
            ...
            3 => Some(TransactionKindLightClient::BatchProverMethodId),
